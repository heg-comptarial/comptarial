...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('immobilier', function (Blueprint $table) {
            ...
            $table->string('pays');
            $table->string('noParcelleGeneve')->nullable();
            ...
            $table->string('autreProprietaire')->comment('Nom de autre propriétaire')->nullable();
            $table->decimal('prixAchat', 10);
            $table->decimal('valeurLocativeBrut', 10)->nullable();
            $table->decimal('loyersEncaisses', 10)->nullable();
            $table->decimal('fraisEntretienDeductibles', 10)->nullable();
